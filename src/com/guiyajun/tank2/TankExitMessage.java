        ...
        try {
            ...
            for (int i=0; i<tankWarClient.HeroTanksList.size(); i++) {
                ...
                if (tank.id == id) {
                    ...
                    tankWarClient.HeroTanksList.remove(tank);
                    Message message = new TankExitRecievedMessage(id, tankWarClient);
